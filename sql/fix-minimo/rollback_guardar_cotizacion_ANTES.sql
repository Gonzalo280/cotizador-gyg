-- ROLLBACK — estado de guardar_cotizacion ANTES del fix del mínimo por línea (Opción B).
-- Capturado en vivo desde producción (pg_get_functiondef) el 2026-08-14, antes de
-- crear el branch de Supabase "fix-minimo". Re-ejecutar este archivo completo
-- restaura exactamente el comportamiento previo (mínimo aplicado al UNITARIO,
-- antes de multiplicar por cantidad).
--
-- Verificado idéntico, en ese momento, a sql/paso3/guardar_cotizacion_v2_2026-08-01.sql
-- (sin drift entre lo desplegado y lo versionado).
